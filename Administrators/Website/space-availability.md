...
| `congregation-label` | The word used for "Congregation" in the picker's label — defaults to **Parish**. Use this if your organization calls them something else (Campus, Site, Location, etc.). | `congregation-label="Campus"` |
